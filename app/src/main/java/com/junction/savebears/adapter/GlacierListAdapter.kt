...
import com.junction.savebears.model.GlacierDataModel

class GlacierInfoAdapter : RecyclerView.Adapter<GlacierInfoAdapter.ViewHolder>() {

    private val items = mutableListOf<GlacierDataModel>()
    ...
    fun addItem(items: List<GlacierDataModel>) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: GlacierDataModel) {
